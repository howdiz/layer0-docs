...
4. Set the `includeCacheMisses :true` prefetch install option. This should be used with caution and is not recommneded for use in Production becuase it significantly increase requests to your origin or API servers.
