...
{{ PRODUCT_NAME }} provides JS workers in multiple regions which can use used for server side rendering (SSR) and many other use cases. See [Serverless Functions](serverless_functions) for examples.  
